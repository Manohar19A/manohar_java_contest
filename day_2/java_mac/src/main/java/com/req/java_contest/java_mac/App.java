...
public class App 
{
  ...
  System.out.println("a Particular product");
    ...
    System.out.println("==============================================");
    System.out.println("Byb Places");
    List<Product> place = service.getProductByPlace("Table");
    System.out.print("Places"+place);
    System.out.println("==============================================");
    System.out.println("By Warranty");
    List<Product> outofWaranty = service.getProductByWarranty(2023);
    System.out.println("OutOfWaranty Products"+outofWaranty);
